...
data:
  ...
  code: "// TODO: sparse \u306E\u3068\u304D\n\nuse modint::ModInt;\n\nuse crate::{mul::FpsMul,\
    \ FormalPowerSeries, FpsInv};\n\nimpl<M: ModInt<Value = u32> + FpsMul + FpsInv>\
    \ FormalPowerSeries<M> {\n    pub fn log(&self, d: usize) -> Self {\n        assert_eq!(self[0].val(),\
...
documentation_of: crates/polynomial/formal_power_series/src/log.rs
layout: document
redirect_from:
- /library/crates/polynomial/formal_power_series/src/log.rs
- /library/crates/polynomial/formal_power_series/src/log.rs.html

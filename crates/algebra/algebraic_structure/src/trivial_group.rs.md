...
data:
  ...
  code: "use algebraic_traits::define_algebra;\n\ndefine_algebra! {\n    pub,\n  \
    \  name: TrivialGroup,\n    value: (),\n    op: |_, _| (),\n    unit: (),\n  \
    \  inv: |_| (),\n    associative,\n    commutative,\n    idempotent,\n}\n"
  dependsOn:
...
documentation_of: crates/algebra/algebraic_structure/src/trivial_group.rs
layout: document
redirect_from:
- /library/crates/algebra/algebraic_structure/src/trivial_group.rs
- /library/crates/algebra/algebraic_structure/src/trivial_group.rs.html

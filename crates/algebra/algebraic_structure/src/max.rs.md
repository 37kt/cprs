...
documentation_of: crates/algebra/algebraic_structure/src/max.rs
layout: document
redirect_from:
- /library/crates/algebra/algebraic_structure/src/max.rs
- /library/crates/algebra/algebraic_structure/src/max.rs.html

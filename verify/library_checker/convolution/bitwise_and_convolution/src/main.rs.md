...
data:
  ...
  code: "// verification-helper: PROBLEM https://judge.yosupo.jp/problem/bitwise_and_convolution\n\
    ...
    \ as Mint;\n\n#[fastout]\nfn main() {\n    input! {\n        n: usize,\n     \
    \   a: [Mint; 1 << n],\n        b: [Mint; 1 << n],\n    }\n\n    let c = bitwise_and_convolution::<AddMulOperator<_>>(&a,\
    \ &b);\n    for i in 0..c.len() {\n        print!(\"{}\", c[i]);\n        print!(\"\
    {}\", if i == c.len() - 1 { \"\\n\" } else { \" \" });\n    }\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/library_checker/convolution/bitwise_and_convolution/src/main.rs
layout: document
redirect_from:
- /verify/verify/library_checker/convolution/bitwise_and_convolution/src/main.rs
- /verify/verify/library_checker/convolution/bitwise_and_convolution/src/main.rs.html

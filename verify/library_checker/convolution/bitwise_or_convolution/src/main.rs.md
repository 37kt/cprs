...
data:
  ...
  code: "// verification-helper: PROBLEM https://judge.yosupo.jp/problem/bitwise_and_convolution\n\
    ...
    \ as Mint;\n\n#[fastout]\nfn main() {\n    input! {\n        n: usize,\n     \
    \   mut a: [Mint; 1 << n],\n        mut b: [Mint; 1 << n],\n    }\n    a.reverse();\n\
    \    b.reverse();\n    let mut c = bitwise_or_convolution::<AddMulOperator<_>>(&a,\
    \ &b);\n    c.reverse();\n    for i in 0..c.len() {\n        print!(\"{}\", c[i]);\n\
    \        print!(\"{}\", if i == c.len() - 1 { \"\\n\" } else { \" \" });\n   \
    \ }\n}\n"
  dependsOn:
...
layout: document
redirect_from:
- /verify/verify/library_checker/convolution/bitwise_or_convolution/src/main.rs
- /verify/verify/library_checker/convolution/bitwise_or_convolution/src/main.rs.html

...
data:
  ...
  code: "// verification-helper: PROBLEM https://judge.yosupo.jp/problem/inverse_matrix\n\
    ...
    \ {\n    input! {\n        n: usize,\n        a: [[Mint; n]; n],\n    }\n    let\
    \ a = Matrix::<AddMulOperator<_>>::from_fn(n, n, |i, j| a[i][j]);\n    let Some(inv)\
    \ = a.inv() else {\n        println!(\"-1\");\n        return;\n    };\n    for\
    \ i in 0..n {\n        for j in 0..n {\n            print!(\"{} \", inv[i][j]);\n\
    \        }\n        println!();\n    }\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/library_checker/linear_algebra/inverse_matrix/src/main.rs
layout: document
redirect_from:
- /verify/verify/library_checker/linear_algebra/inverse_matrix/src/main.rs
- /verify/verify/library_checker/linear_algebra/inverse_matrix/src/main.rs.html

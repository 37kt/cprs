...
data:
  ...
  code: "// verification-helper: PROBLEM https://judge.yosupo.jp/problem/pow_of_matrix\n\
    ...
    \ {\n    input! {\n        n: usize,\n        k: usize,\n        a: [Mint; n *\
    \ n],\n    }\n    let a = Matrix::<AddMulOperator<_>>::from_fn(n, n, |i, j| a[i\
    \ * n + j]);\n    let b = a.pow(k);\n    for i in 0..n {\n        for j in 0..n\
    \ {\n            print!(\"{} \", b[i][j]);\n        }\n        println!();\n \
    \   }\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/library_checker/linear_algebra/pow_of_matrix/src/main.rs
layout: document
redirect_from:
- /verify/verify/library_checker/linear_algebra/pow_of_matrix/src/main.rs
- /verify/verify/library_checker/linear_algebra/pow_of_matrix/src/main.rs.html

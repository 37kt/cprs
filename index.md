...
data:
  libraryCategories:
  - name: crates/algebra/algebraic_structure/src
    pages:
  ...
  - name: crates/algebra/numeric_traits/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/data_structure/offline_dynamic_convex_hull_trick/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/data_structure/segment_tree/lazy_segment_tree/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/data_structure/union_find/union_find/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/data_structure/wavelet_matrix/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/graph/strongly_connected_components/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/number_theory/modint/modint/src
    pages:
    - icon: ':warning:'
  ...
  - name: crates/number_theory/prime_factorization/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/number_theory/rational/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/polynomial/formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/tree/dynamic_rerooting_tree_dp/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/tree/rerooting_tree_dp/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/bitwise_or_convolution/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/bitwise_xor_convolution/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/convolution_mod/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/convolution_mod_1000000007/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/convolution_mod_2_64/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/gcd_convolution/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/lcm_convolution/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/min_plus_convolution_concave_arbitrary/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/min_plus_convolution_convex_arbitrary/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/convolution/min_plus_convolution_convex_convex/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/associative_array_bt/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/deque_operate_all_composite/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/persistent_unionfind/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/point_add_rectangle_sum/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/range_affine_point_get/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/range_affine_range_sum/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/range_kth_smallest/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/rectangle_add_point_get/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/rectangle_sum/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/static_range_frequency/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/static_range_frequency_mo/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/unionfind_with_potential/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/data_structure/unionfind_with_potential_non_commutative_group/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/linear_algebra/matrix_det/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/linear_algebra/matrix_product/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/linear_algebra/matrix_rank/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/linear_algebra/pow_of_matrix/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/number_theory/enumerate_primes_era/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/number_theory/enumerate_primes_ls/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/number_theory/factorize/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/number_theory/primality_test/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/number_theory/sqrt_mod/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/exp_of_formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/exp_of_formal_power_series_not_ntt_friendly/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/inv_of_formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/inv_of_formal_power_series_not_ntt_friendly/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/log_of_formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/pow_of_formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/polynomial/sqrt_of_formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/string/zalgorithm/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/library_checker/tree/lca/src
    pages:
    - icon: ':heavy_check_mark:'
      path: verify/library_checker/tree/lca/src/main.rs
      title: verify/library_checker/tree/lca/src/main.rs
  - name: verify/library_checker/tree/point_set_tree_path_composite_sum/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/stress_test/number_theory/comparing_rational/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/yukicoder/dp/yuki0705_larsch/src
    pages:
    - icon: ':heavy_check_mark:'
...
Rust によって実装された競技プログラミング専用ライブラリです。  

## 注意

- 大きな破壊的変更を頻繁に繰り返しています。
- バグが含まれている可能性があります。

## ライセンス

CC0 ライセンスで公開しています。自己責任にてご自由にお使いください。

...
data:
  ...
  - name: crates/convolution/convolution-arbitrary-mod/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/convolution/subset-convolution/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: crates/data-structure/persistent-array/src
    pages:
    - icon: ':warning:'
  ...
  - name: verify/convolution_mod_1000000007/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/discrete_logarithm_mod/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/inv_of_formal_power_series/src
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: verify/kth_term_of_linearly_recurrent_sequence/src
    pages:
    - icon: ':heavy_check_mark:'
